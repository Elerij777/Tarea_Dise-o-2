...
class SolicitudModel {
    ...
    static getSolicitudById = async (req, res) => {
        try {
            const { id } = req.params;
    ...
    static updateSolicitud = async (req, res) => {
        const payload = req.body;
        const { id } = req.params;
    ...
    static updateSolicitudEstado = async (req, res) => {
        const payload = req.body;
        const { id } = req.params;
        ...
        try {
            ...
            // Actualizamos únicamente el campo estado en el modelo
